...
namespace FZADClient.Controllers
{
    public class HomeController : Controller
    {
        ...
        public async Task<string> Secret()
        {
            ...
            var res =  await HandleSecuredRequest(async () => await SecuredGetRequest("https://oidoauth.fozzy.ua/f5-oauth2/v1/userinfo"));
        ...
        public async Task<string> Revoke() 
        {
            ...
            var request = new HttpRequestMessage(HttpMethod.Post, "https://oidoauth.fozzy.ua/f5-oauth2/v1/token/revoke")
            {
        ...
        private async Task RefreshToken() 
        {
            ...
            var request = new HttpRequestMessage(HttpMethod.Post, "https://oidoauth.fozzy.ua/f5-oauth2/v1/token")
            {
                Content = new FormUrlEncodedContent(data)
            };
